...
Tap **🎵 Chant tones & scan** on a verse to see one combined view: each pāda labelled with its recitation tone (▲ high / ◆ mid / ▼ low) AND marked with **–** guru / **‿** laghu above every syllable. The tones are a recitation aid (not canonical Vedic svara — laukika verses carry no textual accent); the guru/laghu marks are the rigorous scansion.
