...
Tap **📐 Scan** on a verse to see the – / ‿ marks rendered above each syllable, grouped by pāda — the traditional scansion notation. This is verifiable: it's computed from the text by fixed rules, and you can check it against any documented verse.

Tap **🎵 Chant tones** to see the recitation pitch contour (a recitation aid, not canonical Vedic svara — laukika verses carry no textual accent).
